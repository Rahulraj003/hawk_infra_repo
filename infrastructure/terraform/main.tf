...
resource "helm_release" "argocd" {
  ...
  # Password is auto-generated by ArgoCD - no configuration needed
}

# Note: ArgoCD manages its own admin credentials internally
# Username is hardcoded as 'admin', password is set via Helm values
